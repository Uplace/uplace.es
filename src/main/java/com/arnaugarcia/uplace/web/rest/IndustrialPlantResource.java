...
public class IndustrialPlantResource {
    ...
    public IndustrialPlantResource(IndustrialPlantRepository industrialPlantRepository) {
    ...
    public ResponseEntity<IndustrialPlant> createIndustrialPlant(@RequestBody IndustrialPlant industrialPlant) throws URISyntaxException {
        ...
        IndustrialPlant result = industrialPlantRepository.save(industrialPlant);
    ...
    @Timed
    public List<IndustrialPlant> getAllIndustrialPlants() {
        log.debug("REST request to get all IndustrialPlants");
    ...
    public ResponseEntity<IndustrialPlant> getIndustrialPlant(@PathVariable Long id) {
        ...
        IndustrialPlant industrialPlant = industrialPlantRepository.findOne(id);
