...
public class OfficeResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllOfficesByEnergyCertificateIsEqualToSomething() throws Exception {
        // Initialize the database
        officeRepository.saveAndFlush(office);

        // Get all the officeList where energyCertificate equals to DEFAULT_ENERGY_CERTIFICATE
        defaultOfficeShouldBeFound("energyCertificate.equals=" + DEFAULT_ENERGY_CERTIFICATE);

        // Get all the officeList where energyCertificate equals to UPDATED_ENERGY_CERTIFICATE
        defaultOfficeShouldNotBeFound("energyCertificate.equals=" + UPDATED_ENERGY_CERTIFICATE);
    }

    @Test
    @Transactional
    public void getAllOfficesByEnergyCertificateIsInShouldWork() throws Exception {
        // Initialize the database
        officeRepository.saveAndFlush(office);

        // Get all the officeList where energyCertificate in DEFAULT_ENERGY_CERTIFICATE or UPDATED_ENERGY_CERTIFICATE
        defaultOfficeShouldBeFound("energyCertificate.in=" + DEFAULT_ENERGY_CERTIFICATE + "," + UPDATED_ENERGY_CERTIFICATE);

        // Get all the officeList where energyCertificate equals to UPDATED_ENERGY_CERTIFICATE
        defaultOfficeShouldNotBeFound("energyCertificate.in=" + UPDATED_ENERGY_CERTIFICATE);
    }

    @Test
    @Transactional
    public void getAllOfficesByEnergyCertificateIsNullOrNotNull() throws Exception {
        // Initialize the database
        officeRepository.saveAndFlush(office);

        // Get all the officeList where energyCertificate is not null
        defaultOfficeShouldBeFound("energyCertificate.specified=true");

        // Get all the officeList where energyCertificate is null
        defaultOfficeShouldNotBeFound("energyCertificate.specified=false");
    }
    /**
